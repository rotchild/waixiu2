...
public class MyTaskObject implements Serializable {
	private String repaircase_id,case_No,case_id,car_No,brand_name,is_target,target_No,isvip,parters_name,
	...
	public MyTaskObject(String repaircase_id, String case_No, String case_id,
			String car_No, String brand_name, String is_target,
			String target_No, String isvip, String parters_name,
			String parter_manager, String parter_mobile, String dingsuner_name,
			String dingsuner_mobile, String yard_time, String waixiu_time,
			String waixiu_depart, String waixu_peijian, String peijian_price,
	...
	public String getRepaircase_id() {
		return repaircase_id;
	}
	public void setRepaircase_id(String repaircase_id) {
		this.repaircase_id = repaircase_id;
	}
