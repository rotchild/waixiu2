...
/*	toFinishBtn.setOnClickListener(new OnClickListener(){
	...
	repaircase_id=selectTask.getRepaircase_id();
...
public void toFinishTask(){
	savePd=ProgressDialog.show(WaixiuDetailActivity.this, "提交中", "请稍候...");
	...
	params.put("repaircase_id", repaircase_id);
	...
	asyncHttpClient.post(toFinishUrl, params, new JsonHttpResponseHandler(){
		...
		public void onSuccess(int statusCode, JSONObject response) {
			...
			if(savePd!=null&&savePd.isShowing()){
				savePd.dismiss();
				savePd=null;
			}
			...
			try{
				...
				if(success){
					...
					Toast.makeText(WaixiuDetailActivity.this, "数据解析错误", Toast.LENGTH_SHORT).show();
				}
		...
		public void onFailure(Throwable e, JSONObject errorResponse) {
			...
			Toast.makeText(WaixiuDetailActivity.this, "提交失败，请重试", Toast.LENGTH_SHORT).show();
		}
