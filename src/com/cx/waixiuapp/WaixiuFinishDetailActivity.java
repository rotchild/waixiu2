...
public class WaixiuFinishDetailActivity extends Activity {
	...
	Button waixiulookBtn,waixiuFinishLookBtn;
	MyNoteShowDialog mNoteShowDialog;
	String canRepairStr="2";//默认不可修
	String noteStr="";
	String finishNoteStr="";
	@Override
...
//	gusunPrice=(TextView)findViewById(R.id.waixiufinish_gusunmoney_tv);
	...
	waixiuFinishLookBtn=(Button)findViewById(R.id.waixiuw_finishlook_btn);
	...
	finishNoteStr=selectTask.getOutrepair_note();
	...
	waixiuFinishLookBtn.setOnClickListener(new OnClickListener(){//外修完成备注

		@Override
		public void onClick(View v) {
			// TODO 自动生成的方法存根
			showNoteDialog(finishNoteStr);
		}
